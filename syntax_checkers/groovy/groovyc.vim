"============================================================================
"File:        groovyc.vim
"Description: Groovy syntax checking plugin for syntastic. Heavily based on
"             javac syntax checker.
"Maintainer:  Jiří Kratochvíl <kratochvil.jiri.cz at gmail dot com>
...
if !exists('g:syntastic_groovy_groovyc_config_file')
    let g:syntastic_groovy_groovyc_config_file = '.syntastic_javac_config'
endif
